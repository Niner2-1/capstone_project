...
<div class = "navbar navbar-default navbar-fixed-top">
	...
	<div id = "content">
		...
		if(ISSET($_POST['save_patient'])){
			...
			// Since itr_no is auto-incremented, you don't need to check for duplicates or specify it in the query.
			$conn->query("INSERT INTO `patient_record` (phil_health_no, firstname, middlename, lastname, birthdate, age, region, province, city, barangay, street_address, civil_status, sex) VALUES ('$phil_health_no', '$firstname', '$middlename', '$lastname', '$birthdate', '$age', '$region', '$province', '$city', '$barangay', '$street_address', '$civil_status', '$gender')") or die(mysqli_error());
