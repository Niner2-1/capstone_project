...
<html lang = "en">
	...
	<div class = "navbar navbar-default navbar-fixed-top">
		<img src = "images/logo.png" height = "55px" style = "float:left;"><label class = "navbar-brand">LAFUENTE MEDICAL CLINIC Patient Record Management Information System - Padre Burgos</label>
	...
	<div class = "well">
		...
		<table id = "table" cellspacing = "0" class = "display">
			...
			<?php 
				$conn = new mysqli("localhost", "root", "", "capstonedbdraft") or die(mysqli_error());
				$q = $conn->query("SELECT * FROM  `patient_record` GROUP BY `itr_no` DESC") or die(mysqli_error());
			...
			?>
				<tr>
					...
					<td><?php echo $f['region']." ".$f['province']." ".$f['city']." ".$f['barangay']   ?></td>
					<td>
						<center>
							<a href = "all_record.php?itr_no=<?php echo $f['itr_no']?>&urinalysis_id=<?php //echo $f['urinalysis_id']?>"class = "btn btn-info"><span class = "glyphicon glyphicon-book"></span> All Records</a> 
						</center>
					</td>
				</tr>
			<?php
